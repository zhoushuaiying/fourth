...
//            }
        ...
        else
        {
            ...
            switch ($tag_sel)
            {
                ...
                case 'insert' :
                    ...
                    $out = "<?php \n" . '$k = ' . preg_replace_callback("/(\'\\$[^,]+)/" , function($arr){
                        return stripslashes(trim($arr[1],'\''));
                    }, var_export($t, true)) . ";\n";
    ...
    function get_val($val)
    {
        ...
        {
            $val = preg_replace_callback("/\[([^\[\]]*)\]/", function($arr){
    ...
    function smarty_prefilter_preCompile($source)
    {
        ...
        if ($file_type == '.dwt')
        {
            ...
            $source      = preg_replace_callback($pattern, function($arr){
                return '{include file='.strtolower($arr[1]). '}';
            }, $source);
