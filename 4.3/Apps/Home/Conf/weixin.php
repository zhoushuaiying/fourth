	...
	'MENU_CONFIG'           =>  array(
			'button' => array(
				...
				array(
					  'type' => 'view',
					  'name' => '手机书店',
					  'url' => 'http://zhousy.5awo.com'),
				array(
					  'type' => 'view', 
					  'name' => '家庭教育',
					  'url' => 'http://zhousy.5awo.com/Index/book_list'),
				array(
					...
					'sub_button' => array(
							array(
								'type' => 'view',
								'name' => '用户中心',
								'url'  => 'http://zhousy.5awo.com/Index/usercenter',
								),	
							array(
								'type' => 'click',
								'name' => '签到',
							...
							array(
								'type' => 'view',
								'name' => '我的购物车',
								'url'  => 'http://zhousy.5awo.com/Index/cart',
								),
							array(
							'type' => 'view',
							'name' => '订单列表',
							'url'  => 'http://zhousy.5awo.com/Index/order',
							),	
						),	
