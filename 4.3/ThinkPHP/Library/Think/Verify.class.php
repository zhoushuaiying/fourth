...
class Verify {
    ...
    public function entry($id = '') {
        ...
        // $this->imageW || $this->imageW = $this->length*$this->fontSize*1.5 + $this->length*$this->fontSize/2; 
		 $this->imageW || $this->imageW = $this->length*$this->fontSize*0.5 + $this->length*$this->fontSize/2.5; 
        // 图片高(px)
        // $this->imageH || $this->imageH = $this->fontSize * 2.5;
		$this->imageH || $this->imageH = $this->fontSize * 1.4;
        ...
        if($this->useZh){ // 中文验证码
            ...
            for ($i = 0; $i<$this->length; $i++) {
				...
				$codeNX  += mt_rand($this->fontSize*0.6, $this->fontSize*0.6);
                // imagettftext($this->_image, $this->fontSize, mt_rand(-40, 40), $codeNX, $this->fontSize*1.6, $this->_color, $this->fontttf, $code[$i]);
				 imagettftext($this->_image, $this->fontSize, mt_rand(-12, 12), $codeNX, $this->fontSize*1.0, $this->_color, $this->fontttf, $code[$i]);
            }
        }
